...
a member of the class) f that takes String object as a parameter and only displays the contents 
of the string to the screen using String class member function list. The prototype of the function is:
void f(String s);
